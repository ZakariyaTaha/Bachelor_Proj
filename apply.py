...
parser.add_argument('--maxdisp', type=int, default=255,
                    help='maxium disparity')
parser.add_argument('--loss_weights', type=float, nargs='+', default=[0.25, 0.5, 1., 1.])
parser.add_argument('--max_disparity', type=int, default=255)
...
def main():
    ...
    for batch_idx, (imgL, imgR, disp_L) in enumerate(TestImgLoader):
        ...
        Image.fromarray(output_0.cpu().numpy()).convert('L').save('new_data_0.png')
        Image.fromarray(output_1.cpu().numpy()).convert('L').save('new_data_1.png')
        Image.fromarray(output_2.cpu().numpy()).convert('L').save('new_data_2.png')
